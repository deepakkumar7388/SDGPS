...
override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
    ...
    private fun setupOtherInfoDescription(){
        ...
        if(visitorData?.containsKey("lastUpdatedBy") == true)descriptionString+="Last Updated By: ${visitorData?.get("lastUpdatedBy")}\n"
        if(visitorData?.containsKey("remark") == true)descriptionString+="Remark: ${visitorData?.get("remark")}\n"
